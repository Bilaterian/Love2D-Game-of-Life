...
function love.draw()
    ...
    love.graphics.setColor(love.math.colorFromBytes(brushButtons.getColor(4)))
    ...
    love.graphics.setColor(love.math.colorFromBytes(brushButtons.getColor(11)))
    love.graphics.rectangle("fill", dimensions[1], dimensions[2], dimensions[3], dimensions[4])
    ...
    love.graphics.setColor(love.math.colorFromBytes(brushButtons.getColor(14)))
    love.graphics.rectangle("fill", dimensions[1], dimensions[2], dimensions[3], dimensions[4])
    ...
    love.graphics.setColor(love.math.colorFromBytes(brushButtons.getColor(7)))
    love.graphics.rectangle("fill", dimensions[1], dimensions[2], dimensions[3], dimensions[4])
    ...
    love.graphics.setColor(love.math.colorFromBytes(brushButtons.getColor(8)))
    love.graphics.rectangle("fill", dimensions[1], dimensions[2], dimensions[3], dimensions[4])
    ...
    love.graphics.setColor(love.math.colorFromBytes(brushButtons.getColor(9)))
    love.graphics.rectangle("fill", dimensions[1], dimensions[2], dimensions[3], dimensions[4])
